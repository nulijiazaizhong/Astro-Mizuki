...
export const siteConfig: SiteConfig = {
	title: "晚安的静谧小屋",
	subtitle: "晚安的学习、游玩、成长总结",
	siteURL: "https://blog.goodnightan.com", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-09-02", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	navbarTitle: {
		...
		icon: "assets/home/wan.webp",
		// 网站Logo图片路径
		logo: "assets/home/wan.webp",
	},
	...
	banner: {
		...
		src: {
			desktop: ["https://api.goodnightan.com/api/random?type=pc"], // 桌面横幅图片
			mobile: ["https://api.goodnightan.com/api/random?type=mobile"], // 移动横幅图片
		}, // 使用本地横幅图片
		...
		homeText: {
			...
			subtitle: [
				...
				"开始很美，过程很累，结局很悲，清醒很难",
				"突如其来的脾气，往往是积攒很久了的委屈",
				"我见过你爱我的样子，所以我确定你不爱我了",
				"我把阳光都藏进了抽屉，所以我的世界总是雨季",
	...
	font: {
		...
		asciiFont: {
			...
			fontFamily: "pinrushouxie”,LikeJianJianTi-Regular",
			fontWeight: "400",
			localFonts: ["pinrushouxie.ttf,LikeJianJianTi-Regular.ttf"],
	...
	links: [
		...
		},
		{
			...
			children: [
				{
					name: "节点监控",
					url: "https://node.goodnightan.com/",
					icon: "mdi:server",
					external: true,
				},
				{
					name: "服务监控",
					url: "https://uptime.ets2la.cn/status/goodnightan",
					icon: "mdi:server",
					external: true,
				},
				// {
	...
	links: [
		{
			...
			url: "https://github.com/nulijiazaizhong",
		},
		{
			name: "Bilibili",
			icon: "fa7-brands:bilibili",
			url: "https://space.bilibili.com/525984002",
		},
		{
			name: "Discord",
			icon: "fa7-brands:discord",
			url: "https://discordapp.com/users/1095284199520469112",
		},
	],
};
...
export const footerConfig: FooterConfig = {
	enable: true, // 是否启用 Footer HTML 注入功能
...
export const sidebarLayoutConfig: SidebarLayoutConfig = {
	...
	// 侧栏组件布局配置
	components: {
		left: ["profile", "announcement", "site-stats"],
		right: ["card-toc", "music-sidebar"],
		drawer: [
			"profile",
			"announcement",
			"music-sidebar",
